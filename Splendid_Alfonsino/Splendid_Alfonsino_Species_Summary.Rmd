...
```{r manaagment table,message=FALSE,warning=FALSE, echo=FALSE}
...
tabledat%>%kbl(col.names=c("Convention or Management Principle","Status","Comment or Consideration"), caption = "Management Summary")%>%
  kable_classic_2(full_width=F)%>%
  column_spec(2, color = hcolor[tabledat$Status+1],
              background = hcolor[tabledat$Status+1]) %>% 
  row_spec(0, bold = T) %>% 
  footnote("\\\\textcolor{green}{OK}, \\\\textcolor{yellow}{Intermediate}, \\\\textcolor{red}{Not accomplished}, \\\\textcolor{gray}{Unknown}", title_format="bold", escape = FALSE)
```
